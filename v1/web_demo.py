...
#             # The KB is unreachable/slow even after search_knowledge_base's own
#             # retry - tell the caller something sensible instead of a raw
#             # network exception, same "admit it, don't guess" rule as low KB
#             # confidence gets.
#             kb_result = {"answer": ""}

#         if not kb_result.get("answer"):
#             spoken_answer = (
...
from v1.voice_helpdesk_pipeline import (
    FILLER_DIR,
    ask_gpt,
    get_or_create_filler,
    search_knowledge_base,
...
def answer():
    ...
    try:
        ...
        # KB is genuinely slow/unreachable right now - give the caller something
        # spoken instead of silence or a raw error, rather than failing the turn.
